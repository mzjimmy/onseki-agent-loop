...
check("uploaded-honesty", app.includes("state.uploaded || view.time <= 0") && app.includes("upload.playbackRate = state.speed"), "imports retain transport settings but not invented chapters");
